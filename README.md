<img width="163" height="150" alt="gemini-svg" src="https://github.com/user-attachments/assets/ae9e4657-bca3-4dce-a4d7-04aca2ea8cb1" /># hed-core
...
- Marks the benchmark as Fabric-ready once the deploy flow has been triggered.
  ...
  ![Uploading gemini<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 920" width="100%" height="100%" style="background-color: #0b0f19; font-family: 'Inter', system-ui, -apple-system, sans-serif;">
  <defs>
