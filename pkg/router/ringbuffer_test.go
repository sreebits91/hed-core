...
func strconv.Itoa(i int)string{if i==0{return "0"};b:=make([]byte,0,20);for i>0{b=append(b,byte('0'+i%10));i/=10};for l,r:=0,len(b)-1;l<r;l,r=l+1,r-1{b[l],b[r]=b[r],b[l]};return string(b)}
