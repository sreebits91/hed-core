...
type Pipeline struct{cfg Config;router *Router;dedup *Dedup;wal *WAL;committer *Committer;metrics *Metrics;parts []partition;ctx context.Context;cancel context.CancelFunc;accepting atomic.Bool;recoveryMu sync.Mutex;recovered map[string]struct{};accepting bool;wg sync.WaitGroup;startOnce,stopOnce sync.Once}
